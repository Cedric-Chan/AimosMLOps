...
const INITIAL_DATA: FeatureRow[] = [
  {
    ...
    regions: ["ID", "TH"],
    creator: "cedric.chen@example.com",
...
const LINEAGE_DP_MAP: Record<string, LineageDP[]> = {
  ...
  "2-1": [
    { id: "ldp-2-1-a", name: "acard_score_stream_mx", pipelineType: "FlinkStream", sourceTable: "kafka.acard_events_mx", schedule: "Continuous", lag: "540 ms", ownerEmail: "aaron.loh@example.com", dataverseUrl: "#", syncState: "InSync", taskStatus: "Running" },
  ],
  "2-2": [
    { id: "ldp-2-2-a", name: "acard_score_stream_id", pipelineType: "FlinkStream", sourceTable: "kafka.acard_events_id", schedule: "Continuous", ownerEmail: "aaron.loh@example.com", dataverseUrl: "#", syncState: "NotFound" },
  ],
  "3-1": [
    { id: "ldp-3-1-a", name: "recommend_batch_sg", pipelineType: "SparkBatch", sourceTable: "dwd.user_behavior_sg", schedule: "0 2 * * *", lastSuccessAt: "2026-05-12 02:45:00", ownerEmail: "wei.huang@example.com", dataverseUrl: "#", syncState: "InSync", taskStatus: "Online" },
  ],
  "4-1": [
    { id: "ldp-4-1-a", name: "graph_builder_th", pipelineType: "SparkBatch", sourceTable: "dwd.user_phone_relations", schedule: "0 3 * * *", lastSuccessAt: "2026-05-12 03:20:00", ownerEmail: "cedric.chen@example.com", dataverseUrl: "#", syncState: "InSync", taskStatus: "Online" },
  ],
};
...
const LINEAGE_FG_MAP: Record<string, LineageFG[]> = {
  ...
  "2-1": [{ name: "acard_mx_scoring_fg",       owners: ["aaron.loh@example.com"] }],
  "2-2": [
    { name: "acard_id_v3_fg",           owners: ["aaron.loh@example.com", "wei.huang@example.com"] },
    { name: "credit_acard_combined_fg", owners: ["cedric.chen@example.com"] },
  ],
  "3-1": [{ name: "recommend_shopee_sg_fg", owners: ["wei.huang@example.com"] }],
  "4-1": [{ name: "graph_relation_th_fg",   owners: ["cedric.chen@example.com"] }],
};
...
const MOCK_TEST_HISTORY: Record<string, TestHistoryRecord[]> = {
  "1": [
    { id: "h1-1", region: "ID", createTime: "2026-02-20 14:38:50.000", operator: "cedric.chen@example.com",  status: "Success", input: { user_id: "U883421", id_card_no: "3201011990xxxxxx", platform_user_id: "SPay_ID_883421" }, output: { raw_map: '{"level":"low","detail":"ok"}', risk_score: "72" } },
    { id: "h1-2", region: "ID", createTime: "2026-02-20 14:38:49.000", operator: "cedric.chen@example.com",  status: "Success", input: { user_id: "U662201", id_card_no: "3172021985xxxxxx", platform_user_id: "SPay_ID_662201" }, output: { raw_map: '{"level":"medium"}', risk_score: "48" } },
    { id: "h1-3", region: "TH", createTime: "2026-02-18 10:15:30.000", operator: "aaron.loh@example.com",    status: "Success", input: { user_id: "U_TH_77821" }, output: { raw_map: '{"level":"high"}', data_status: "1" } },
    { id: "h1-4", region: "ID", createTime: "2026-02-15 09:20:10.000", operator: "cedric.chen@example.com",  status: "Failed",  input: { user_id: "U_INVALID", id_card_no: "", platform_user_id: "" }, output: {} },
    { id: "h1-5", region: "TH", createTime: "2026-02-10 16:45:22.000", operator: "hao.wan@example.com",           status: "Success", input: { user_id: "U_TH_55100" }, output: { raw_map: '{"level":"low"}', data_status: "0" } },
  ],
  "2": [
    { id: "h2-1", region: "MX", createTime: "2026-02-21 11:30:00.000", operator: "aaron.loh@example.com",    status: "Success", input: { id_card_no: "MX19921010xxx", platform_user_id: "Spay_MX_441", phone_number: "+521234567890" }, output: { acard_score: "88", acard_tier: "A" } },
    { id: "h2-2", region: "MX", createTime: "2026-02-19 08:50:30.000", operator: "aaron.loh@example.com",    status: "Success", input: { id_card_no: "MX19880205xxx", platform_user_id: "Spay_MX_332", phone_number: "+529876543210" }, output: { acard_score: "61", acard_tier: "B" } },
    { id: "h2-3", region: "ID", createTime: "2026-02-18 14:12:55.000", operator: "cedric.chen@example.com",  status: "Failed",  input: { id_card_no: "3201INVALID",  platform_user_id: "" }, output: {} },
    { id: "h2-4", region: "ID", createTime: "2026-01-30 17:05:40.000", operator: "hao.wan@example.com",           status: "Success", input: { id_card_no: "3201011985xxxxxx", platform_user_id: "SPay_ID_220411" }, output: { acard_score: "75", acard_tier: "A" } },
  ],
  "3": [
    { id: "h3-1", region: "SHOPEE_SG", createTime: "2026-02-22 10:00:00.000", operator: "wei.huang@example.com",  status: "Success", input: { user_id: "SG_USER_9921", scene_id: "homepage_feed" },  output: { item_list: '["item_001","item_002"]', score_map: '{"item_001":0.92}' } },
    { id: "h3-2", region: "SHOPEE_SG", createTime: "2026-02-21 15:30:10.000", operator: "wei.huang@example.com",  status: "Success", input: { user_id: "SG_USER_7712", scene_id: "search_result" }, output: { item_list: '["item_055","item_060"]', score_map: '{"item_055":0.95}' } },
    { id: "h3-3", region: "SHOPEE_SG", createTime: "2026-02-10 09:22:00.000", operator: "lin.liu@example.com", status: "Failed",  input: { user_id: "", scene_id: "homepage_feed" }, output: {} },
  ],
  "4": [
    { id: "h4-1", region: "TH", createTime: "2026-02-20 13:45:00.000", operator: "cedric.chen@example.com", status: "Success", input: { user_id: "TH_USER_4421", depth: "2", relation_type: "transfer" }, output: { node_list: '["node_A","node_B"]', edge_list: '["A->B"]', relation_score: "85" } },
    { id: "h4-2", region: "TH", createTime: "2026-02-15 16:10:30.000", operator: "cedric.chen@example.com", status: "Success", input: { user_id: "TH_USER_3300", depth: "3", relation_type: "loan" },     output: { node_list: '["node_X","node_Y"]', edge_list: '["X->Y"]', relation_score: "62" } },
  ],
};
  ...
  const handleMetaSubmit = (data: MetaFormData, mode: "add" | "editMeta", rowId?: string) => {
    if (mode === "add") {
      setTableData(prev => [...prev, {
        ...
        dataLatency: data.dataLatency, regions: [], creator: "current.user@example.com",
