...
// ── Data ─────────────────────────────────────────────────────────────────────
var MOCK_DATA = [
  { id:"1", name:"user_risk_score_fg",       region:"TH",        module:"Credit Buyer Behavior", owner:"cedric.chen@example.com",  updateTime:"2026-02-16 08:30:00", description:"User risk scoring feature group for Thailand market, aggregates behavioral signals and transaction patterns." },
  { id:"2", name:"mx_acard_realtime_fg",     region:"MX",        module:"External Data",         owner:"aaron.loh@example.com",     updateTime:"2026-02-15 11:00:00", description:"Real-time feature group for Mexico A-card model, capturing live transaction velocity and account age features." },
  { id:"3", name:"th_embedding_fg_v3",       region:"TH",        module:"External Data",         owner:"sandeep.rao@example.com",  updateTime:"2026-02-11 16:20:00", description:"Version 3 of Thailand embedding feature group, includes improved user graph embeddings and NLP-derived features." },
  { id:"4", name:"dp_recommend_score_fg",    region:"SHOPEE_SG", module:"Credit Buyer Behavior", owner:"wei.huang@example.com",          updateTime:"2026-02-16 13:45:00", description:"Feature group for Shopee Singapore recommendation scoring." },
  { id:"5", name:"user_graph_relation_fg",   region:"TH",        module:"Credit Buyer Behavior", owner:"cedric.chen@example.com",  updateTime:"2026-02-13 09:00:00", description:"User social graph and relation feature group, derives network-based features for fraud detection models." },
  { id:"6", name:"mx_device_fingerprint_fg", region:"MX",        module:"External Data",         owner:"xavier.kuang@example.com",     updateTime:"2026-02-15 20:00:00", description:"Device fingerprint feature group for Mexico, tracks device identity signals and cross-device behavior patterns." }
];
