...
> = {
  "user_tx_features.credit_amount_30d": {
    ...
    attestedBy: "cedric.chen@example.com",
...
function HistoryTab() {
  const events = [
    { ts: "2026-05-12 14:30:21", event: "Consistency attested", actor: "cedric.chen@example.com", note: "30d 滑窗 SUM..." },
    { ts: "2026-05-10 09:15:03", event: "Description updated", actor: "wei.huang@example.com", note: undefined as string | undefined },
