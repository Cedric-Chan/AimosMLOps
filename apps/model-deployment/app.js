...
const MODELS = [
  { name: 'id_splx_txn_cp', version: 'v2.1', region: 'id', team: 'DataSci', owners: ['cedric.chen@example.com', 'aaron.loh@example.com'] },
  { name: 'realtime-hpl-acard-isolated', version: 'v1.0', region: 'ph', team: 'DataSci', owners: ['aaron.loh@example.com'] },
  { name: 'funding-rac-test-model', version: 'v1.0', region: 'id', team: 'DataMart', owners: ['ying.chen@example.com'] },
  { name: 'funding-rac-test-model', version: 'v1.1', region: 'id', team: 'DataMart', owners: ['ying.chen@example.com'] },
  { name: 'mx_bureau', version: 'v1.0', region: 'mx', team: 'DataSci', owners: ['aaron.loh@example.com', 'jason.yang@example.com'] },
  { name: 'mx_bureau', version: 'v2.0-rc', region: 'mx', team: 'DataSci', owners: ['aaron.loh@example.com'] },
  { name: 'ph_cic', version: 'v2.0', region: 'ph', team: 'DataSci', owners: ['zoe.liu@example.com'] },
  { name: 'ph_cic', version: 'v2.1', region: 'ph', team: 'DataSci', owners: ['zoe.liu@example.com'] },
  { name: 'SharkTest', version: 'v1.0', region: 'sg', team: '57', owners: ['alvin.li@example.com'] },
];

/* ---------- seed（对齐线上列表截图口径） ---------- */
const seedRows = [
  { name: 'id_splx_txn_cp', version: 'v2.1', region: 'id', dtype: 'Epic', build: 'v2.1.20250703.1', env: 'prod', status: 'Deployed', created: '2025-07-03 10:30:16', updated: '2025-07-03 11:48:15', owners: ['cedric.chen@example.com', 'aaron.loh@example.com', 'xin.chen@example.com'] },
  { name: 'id_splx_txn_cp', version: 'v2.1', region: 'id', dtype: 'Epic', build: 'v2.1.20250703.1', env: 'staging', status: 'Deployed', created: '2025-07-03 12:02:40', updated: '2025-07-03 12:10:03', owners: ['cedric.chen@example.com'] },
  { name: 'realtime-hpl-acard-isolated', version: 'v1.0', region: 'ph', dtype: 'Epic', build: 'v1.0.20250627.1', env: 'prod', status: 'Deployed', created: '2025-06-27 16:40:54', updated: '2025-06-27 17:23:45', owners: ['aaron.loh@example.com', 'derek.seah@example.com'] },
  { name: 'funding-rac-test-model', version: 'v1.0', region: 'id', dtype: 'K8s', build: 'v1.0.20250715.1', env: 'prod', status: 'Deployed', created: '2025-06-09 17:44:47', updated: '2025-07-15 16:06:30', owners: ['ying.chen@example.com', 'jing.bi@example.com'] },
  { name: 'mx_bureau', version: 'v1.0', region: 'mx', dtype: 'Epic', build: 'v1.0.20250902.1', env: 'prod', status: 'Deployed', created: '2025-06-04 10:21:23', updated: '2025-09-02 13:44:19', owners: ['aaron.loh@example.com', 'jason.yang@example.com'] },
  { name: 'ph_cic', version: 'v2.0', region: 'ph', dtype: 'K8s', build: 'v2.0.20250602.1', env: 'prod', status: 'Deployed', created: '2025-05-26 11:56:10', updated: '2025-06-02 16:58:00', owners: ['zoe.liu@example.com', 'aaron.loh@example.com'] },
  { name: 'mx_bureau', version: 'v2.0-rc', region: 'mx', dtype: 'Epic', build: 'v2.0rc.20250830.1', env: 'staging', status: 'Deploying', created: '2025-08-30 09:12:00', updated: '2025-08-30 09:12:40', owners: ['aaron.loh@example.com'] },
  { name: 'funding-rac-test-model', version: 'v1.1', region: 'id', dtype: 'Serverless', build: 'v1.1.20250901.1', env: 'prod', status: 'Failed', created: '2025-09-01 14:20:11', updated: '2025-09-01 14:26:52', owners: ['ying.chen@example.com'] },
  { name: 'ph_cic', version: 'v2.1', region: 'ph', dtype: 'Epic', build: 'v2.1.20250905.1', env: 'prod', status: 'Failed', created: '2025-09-05 10:08:33', updated: '2025-09-05 10:15:07', owners: ['zoe.liu@example.com'] },
  { name: 'id_splx_txn_cp', version: 'v2.0', region: 'id', dtype: 'Epic', build: 'v2.0.20250620.1', env: 'prod', status: 'Offline', created: '2025-06-20 11:00:00', updated: '2025-07-03 11:50:00', owners: ['cedric.chen@example.com', 'aaron.loh@example.com'] },
  { name: 'SharkTest', version: 'v1.0', region: 'sg', dtype: 'K8s', build: 'v1.0.20251222.1', env: 'prod', status: 'Offline', created: '2025-06-04 15:06:34', updated: '2025-12-22 12:36:32', owners: ['alvin.li@example.com'] },
  { name: 'realtime-hpl-acard-isolated', version: 'v0.9', region: 'ph', dtype: 'Epic', build: 'v0.9.20250610.1', env: 'prod', status: 'Offline', created: '2025-06-10 09:30:00', updated: '2025-06-27 17:30:00', owners: ['aaron.loh@example.com'] },
];
...
function buildInfo(r) {
  return {
    ...
    s3Path: `s3://sg-demo-feature-management-aimos-bff/live/model_management/1788344863860-${r.updated.replace(/[- :]/g, '')}.zip`,
  };
}
