...
const CURRENT_USER = 'cedric.chen@example.com';
...
const seedLLMs = [
  { name: 'Qwen2.5-VL-7B-SFT-V1-ID-Payslip', model: 'Monee/Qwen2.5-VL-7B-SFT-V1', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com'], access: '', region: 'ID', endpoint: EP_AIS, desc: 'Qwen2.5-VL-7B-SFT-V1-ID-Payslip', created: '2026-09-08 17:22:00', updated: '2026-09-08 17:22:00', proxy: true, apikey: 'sk-qw25id001' },
  { name: 'Qwen3-VL-8B-Instruct-ID', model: 'Monee/Qwen3-VL-8B-Instruct', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com', 'sandeep.rao@example.com'], access: '', region: 'ID', endpoint: EP_AIS, desc: '', created: '2026-09-08 10:27:29', updated: '2026-09-08 10:27:29', proxy: true, apikey: 'sk-qw3id002' },
  { name: 'Monee-Qwen3-VL-8B-SFT-V1-New', model: 'Monee/Qwen3-VL-8B-SFT-V1', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com'], access: '', region: 'MY', endpoint: EP_MY, desc: '', created: '2026-09-07 17:29:13', updated: '2026-09-07 17:29:13', proxy: true, apikey: 'sk-my003' },
  { name: 'Qwen3-VL-8B-Instruct-MY-New', model: 'Monee/Qwen3-VL-8B-Instruct', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com'], access: '', region: 'MY', endpoint: EP_MY, desc: '', created: '2026-09-07 15:24:05', updated: '2026-09-07 15:24:05', proxy: true, apikey: 'sk-my004' },
  { name: 'Qwen3.5-VL-9B-SFT-V2-PH-Payslip-Copy', model: 'Monee/Qwen35-VL-9B-SFT-V1', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com', 'jerry.chen@example.com'], access: '', region: 'PH', endpoint: EP_AIS, desc: '', created: '2026-09-04 15:46:42', updated: '2026-09-07 12:21:03', proxy: true, apikey: 'sk-ph005' },
  { name: 'Qwen3-VL-8B-Instruct-PH', model: 'Monee/Qwen3-VL-8B-Instruct', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com', 'jerry.chen@example.com'], access: '', region: 'PH', endpoint: EP_AIS, desc: '', created: '2026-09-04 14:47:35', updated: '2026-09-07 12:20:55', proxy: true, apikey: 'sk-ph006' },
  { name: 'Qwen3-VL-8B-SFT-V1-PH-BIR2316', model: 'Monee/Qwen3-VL-8B-SFT-V1', provider: 'OpenAI', type: 'Chat', owners: ['zeke.xiang@example.com', 'jerry.chen@example.com'], access: '', region: 'PH', endpoint: EP_AIS, desc: '', created: '2026-09-03 18:27:26', updated: '2026-09-07 12:20:34', proxy: true, apikey: 'sk-ph007' },
  { name: 'Same-Person-AIS-Qwen3.6-35B-A3b-PH', model: 'qwen3.6-35b-a3b', provider: 'OpenAI', type: 'Chat', owners: ['jerry.chen@example.com', 'sienna.chen@example.com'], access: '', region: 'PH', endpoint: 'https://ais-di-all.risk.shopee.io/services/808700/v1', desc: '', created: '2026-09-02 18:46:53', updated: '2026-09-02 18:46:53', proxy: true, apikey: 'sk-ph008' },
  { name: 'Qwen3-VL-8B-Instruct-VN', model: 'Monee/Qwen3-VL-8B-Instruct', provider: 'OpenAI', type: 'Chat', owners: ['lin.liu@example.com', 'aaron.loh@example.com'], access: '', region: 'VN', endpoint: EP_AIS, desc: 'Qwen3-VL-8B-Instruct-VN', created: '2026-08-28 16:05:19', updated: '2026-09-07 11:02:23', proxy: true, apikey: 'sk-vn009' },
  { name: 'Same-Person-Qwen3.6-35B-A3b-PH', model: 'qwen3.6-35b-a3b', provider: 'OpenAI', type: 'Chat', owners: ['jerry.chen@example.com', 'sienna.chen@example.com'], access: '', region: 'PH', endpoint: EP_COMPASS, desc: '', created: '2026-08-28 10:24:28', updated: '2026-08-28 10:24:28', proxy: true, apikey: 'sk-ph010' },
  // ── 第 2 页（4 条，共 14）──
  { name: 'Embedding-Risk-Doc-SG', model: 'Monee/bge-large-sg', provider: 'Compass', type: 'Embedding', owners: ['cedric.chen@example.com'], access: 'DataSci', region: 'SG', endpoint: EP_COMPASS, desc: '风控文档向量化 Embedding 模型', created: '2026-08-20 14:10:00', updated: '2026-09-01 09:30:00', proxy: false, apikey: 'sk-sg011' },
  { name: 'Claude-Review-Assistant-MY', model: 'claude-sonnet-4', provider: 'Claude', type: 'Chat', owners: ['cedric.chen@example.com'], access: '', region: 'MY', endpoint: EP_COMPASS, desc: '材料审查辅助', created: '2026-08-15 11:00:00', updated: '2026-08-15 11:00:00', proxy: false, apikey: 'sk-my012' },
  { name: 'Gemini-Doc-Parse-ID', model: 'gemini-2.5-flash', provider: 'Gemini', type: 'Chat', owners: ['aaron.loh@example.com'], access: 'AimosTeam', region: 'ID', endpoint: EP_COMPASS, desc: '', created: '2026-08-10 09:20:00', updated: '2026-08-28 15:00:00', proxy: true, apikey: 'sk-id013' },
  { name: 'Embed-TH-Kyc-Doc', model: 'Monee/bge-base-th', provider: 'Compass', type: 'Embedding', owners: ['lin.liu@example.com'], access: 'RiskPolicy', region: 'TH', endpoint: EP_COMPASS, desc: 'TH KYC 材料向量化', created: '2026-08-01 16:45:00', updated: '2026-08-01 16:45:00', proxy: false, apikey: 'sk-th014' },
];
