...
const OWNERS_POOL = [
  'cedric.chen@example.com', 'aaron.loh@example.com', 'xin.chen@example.com',
  'derek.seah@example.com', 'ying.chen@example.com', 'jing.bi@example.com',
  'alvin.li@example.com', 'jason.yang@example.com', 'zoe.liu@example.com',
  'sienna.chen@example.com',
];
// Owner → Biz Team 映射（mock：真实实现由 Owner 在 Team 中的角色推导）
const OWNER_TEAM = {
  'cedric.chen@example.com': 'AimosTeam',
  'sienna.chen@example.com': 'DataSci',
};
...
const seedModels = [
  { name: 'id_splx_txn_cp', version: 'v2.1', region: 'id', team: 'DataSci', product: 'splx', status: 'Deployed', created: '2025-07-03 10:30:16', updated: '2025-07-03 11:48:15', owners: ['cedric.chen@example.com', 'aaron.loh@example.com', 'xin.chen@example.com'], desc: 'id splx transaction credit policy model' },
  { name: 'realtime-hpl-acard-isolated', version: 'v1.0', region: 'ph', team: 'DataSci', product: 'HPL', status: 'Deployed', created: '2025-06-27 16:40:54', updated: '2025-06-27 17:23:45', owners: ['aaron.loh@example.com', 'derek.seah@example.com'], desc: 'realtime HPL acard isolated model' },
  { name: 'funding-rac-test-model', version: 'v1.0', region: 'id', team: 'DataMart', product: 'SPL', status: 'Deployed', created: '2025-06-09 17:44:47', updated: '2025-07-15 16:06:30', owners: ['ying.chen@example.com', 'jing.bi@example.com'], desc: 'funding rac test model' },
  { name: 'funding-rac-test-model', version: 'v1', region: 'id', team: 'DataMart', product: 'SPL', status: 'Deprecate', created: '2025-06-09 16:30:52', updated: '2025-06-09 17:43:58', owners: ['ying.chen@example.com'], desc: 'funding rac test model (deprecated)' },
  { name: 'SharkTest', version: 'v1.0', region: 'sg', team: '57', product: 'spl', status: 'Deprecate', created: '2025-06-04 15:06:34', updated: '2025-12-22 12:36:32', owners: ['alvin.li@example.com'], desc: 'shark test model' },
  { name: 'mx_bureau', version: 'v1.0', region: 'mx', team: 'DataSci', product: 'SPL', status: 'Deployed', created: '2025-06-04 10:21:23', updated: '2025-09-02 13:44:19', owners: ['aaron.loh@example.com', 'jason.yang@example.com'], desc: 'mx bureau model' },
  { name: 'mx_bureau', version: '1.0', region: 'mx', team: 'DataSci', product: 'SPL', status: 'Deprecate', created: '2025-06-03 18:29:46', updated: '2025-06-04 10:20:46', owners: ['aaron.loh@example.com', 'jason.yang@example.com'], desc: 'mx bureau model (deprecated)' },
  { name: 'ph_cic', version: 'v2.0', region: 'ph', team: 'DataSci', product: 'SPL', status: 'Deployed', created: '2025-05-26 11:56:10', updated: '2025-06-02 16:58:00', owners: ['zoe.liu@example.com', 'aaron.loh@example.com'], desc: 'ph cic model' },
];
...
function buildInfo(m) {
  ...
  return {
    ...
    s3Path: `s3://sg-demo-feature-management-aimos-bff/live/model_management/1788344863860-${m.updated.replace(/[- :]/g, '')}.zip`,
  };
}
